export default ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    getRarityDetail: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, Rarity))], ["query"]),
    ...
    lookProperties: IDL.Func([], [IDL.Vec(IDL.Tuple(Property, IDL.Vec(TokenIndex)))], ["query"]),
    ...
    setRarityDetail: IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, Rarity))], []),
    setScoreOfTokenId: IDL.Func([], [], []),
