...
export const canisterId = process.env.USERS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./users.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the users canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./users.did.js")._SERVICE>}
 */
export const users = createActor(canisterId);
